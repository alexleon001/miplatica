...
export const CATEGORIES: readonly Category[] = [
  ...
  { id: "events",        label: "Eventos",        icon: "🎫", color: "#D946EF", group: "expense" },
  { id: "utilities",     label: "Servicios",      icon: "💡", color: "#06B6D4", group: "expense" },
  { id: "electricity",   label: "Luz",            icon: "⚡", color: "#FACC15", group: "expense" },
  { id: "water",         label: "Agua",           icon: "💧", color: "#38BDF8", group: "expense" },
  { id: "gas",           label: "Gas",            icon: "🔥", color: "#FB923C", group: "expense" },
  { id: "internet",      label: "Internet",       icon: "🌐", color: "#22D3EE", group: "expense" },
  { id: "phone",         label: "Teléfono",       icon: "📱", color: "#818CF8", group: "expense" },
  ...
  { id: "online",        label: "Compra online",  icon: "🛍️", color: "#F472B6", group: "expense" },
  { id: "travel",        label: "Viajes",         icon: "✈️", color: "#0EA5E9", group: "expense" },
  { id: "rent",          label: "Alquiler",       icon: "🏠", color: "#F59E0B", group: "expense" },
  { id: "loan",          label: "Préstamo",       icon: "🏦", color: "#FBBF24", group: "expense" },
